...
import { ArrowRight, HelpCircle, CheckCircle } from 'lucide-vue-next';
    ...
    <div class="min-h-screen bg-background">
        ...
        <div class="border-t bg-muted/40">
            <div class="container mx-auto px-4 py-16 text-center">
                ...
                <Button as-child size="lg" class="h-12 px-8">
                    <NuxtLink to="/builder" class="inline-flex items-center gap-2">
                        Start Building
